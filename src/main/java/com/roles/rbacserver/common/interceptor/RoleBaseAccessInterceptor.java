...
public class RoleBaseAccessInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        boolean containRole = hasRequiredRoleByToken(handler, token);
        if (!containRole) {
    ...
    private boolean hasRequiredRoleByToken(Object handler, String token) {
        ...
        return requiredRole.stream().anyMatch(accountRoles::contains);
    }
